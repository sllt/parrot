...
var CmdWire = &cobra.Command{
	Use:     "wire",
	Short:   "parrot wire [wire.go path]",
	Long:    "parrot wire [wire.go path]",
	Example: "parrot wire cmd/server",
...
var CmdWireAll = &cobra.Command{
	Use:     "all",
	Short:   "parrot wire all",
	Long:    "parrot wire all",
	Example: "parrot wire all",
	Run: func(cmd *cobra.Command, args []string) {
		cmdArgs, _ := helper.SplitArgs(cmd, args)
		var dir string
		if len(cmdArgs) > 0 {
