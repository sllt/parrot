...
import (
	...
	"github.com/sllt/parrot/internal/tpl"
...
var CmdCreate = &cobra.Command{
	...
	Example: "parrot create handler user",
...
var CmdCreateService = &cobra.Command{
	...
	Example: "parrot create service user",
	Args:    cobra.ExactArgs(1),
	Run:     runCreate,
}
var CmdCreateRepository = &cobra.Command{
	...
	Example: "parrot create repository user",
	Args:    cobra.ExactArgs(1),
	Run:     runCreate,
}
var CmdCreateModel = &cobra.Command{
	...
	Example: "parrot create model user",
	Args:    cobra.ExactArgs(1),
	Run:     runCreate,
}
var CmdCreateAll = &cobra.Command{
	Use:     "all",
	Short:   "Create a new handler & service & repository & model",
	Example: "parrot create all user",
	Args:    cobra.ExactArgs(1),
	Run:     runCreate,
}
